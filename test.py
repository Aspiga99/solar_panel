...
import os
os.chdir('/Users/Andrea/projects/SolarDetection-solafune/SolarDetection-solafune')
...
#Model.models = [ tf.keras.models.load_model(f'save_model_{i}.h5', compile = False) for i in range(1, 6) ]

for i in range(1, 6):
    model_path = f'./save_model_{i}.h5'
    print(f"Loading model from: {model_path}")
    try:
        model = tf.keras.models.load_model(model_path, compile=False)
        Model.models.append(model)
